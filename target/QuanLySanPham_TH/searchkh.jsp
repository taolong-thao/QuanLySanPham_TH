        ...
        <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="AdminControl.jsp">AdminControl</a></li>
                    <li class="active"><a href="searchkh.jsp"> Search Khách Hàng</a></li>
    ...
    <div class="container">
        <div class="col-sm-4">
            <div class="search-box">
                <form action="searchkh" method="get">
                    <input type="text" name="name" value="Nhập Tên Khách Hàng">
                    <input type="submit" value="Search">
                </form>
            </div>
        </div>
